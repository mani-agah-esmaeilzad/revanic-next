    ...
    const team = [
        {
            ...
            description: "روزنامه‌نگار و نویسنده با بیش از ۱۵ سال تجربه در حوزه رسانه و مطبوعات ایران."
        },
        {
            name: "فاطمه کریمی",
            role: "سردبیر",
            description: "دکترای ادبیات فارسی و متخصص ویرایش محتوا با سابقه کار در نشریات معتبر کشور."
        },
        {
            name: "علی موسوی",
            role: "مدیر فنی",
            description: "مهندس نرم‌افزار و متخصص طراحی تجربه کاربری با تجربه در شرکت‌های فناوری."
        }
    ];
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <p className="text-xl text-journal-light max-w-3xl mx-auto leading-relaxed">
                            ...
                            در سال ۱۴۰۰ تأسیس شد. ما معتقدیم که هر فردی داستانی برای گفتن دارد.
                        </p>
                    </div>
                </div>
            </section>
