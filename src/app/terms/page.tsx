        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-journal-light">
              قوانین و مقررات استفاده از مجله روانیک
            </p>
          </div>
        </div>
      </section>
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="text-journal-light space-y-4">
                      <p>
                        با دسترسی و استفاده از وب‌سایت مجله روانیک، شما موافقت خود را با این شرایط و قوانین اعلام می‌کنید. اگر با این شرایط موافق نیستید، لطفاً از استفاده از وب‌سایت خودداری کنید.
                      </p>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="text-journal-light space-y-4">
                      <ul className="pr-6 space-y-2">
                        <li>• <strong>مجله:</strong> وب‌سایت مجله روانیک و تمام خدمات مرتبط با آن</li>
                  ...
                  <div className="bg-journal-cream/30 p-6 rounded-lg">
                    ...
                    <p className="text-journal-light text-sm mt-2">
                      برای سوالات یا وضاحت بیشتر در مورد این شرایط، با ما تماس بگیرید: info@revanic.ir
                    </p>
                  </div>
