...
const Subscription = () => {
  ...
  const handleSubscribe = async (tier: PlanTier) => {
    setIsLoading(tier);
    setMessage(null);
    let studentIdCardUrl: string | undefined = undefined;
      ...
      <section className="py-16 bg-journal-cream/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {message && (
              <div
                className={`p-4 mb-4 text-center rounded-lg ${message.includes("موفقیت") || message.includes("ثبت شد") ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
              >
                {message}
              </div>
            )}
